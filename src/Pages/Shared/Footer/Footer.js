...
const Footer = () => {
  return (
    ...
    }} className="mt-6 lg:mb-40 mb-2">
      <div className="container pb-20 px-12 lg:px-72 mx-auto">
    ...
    <p>ACME Industries Ltd.Providing reliable tech since 1992</p>
        ...
        <div>
          <p className="text-center mt-12">Copyright © 2022 - All right reserved by Razib Saha</p>
        </div>
      </div>
    </footer>
  );
